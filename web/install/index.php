...
define('WRITABLE_CONFIG',   is_writable($paths['config']));
define('WRITABLE_DEMOS',    is_writable($paths['demos']));
define('WRITABLE_GAMES',    is_writable($paths['games']));
define('WRITABLE_MAPS',     is_writable($paths['maps']));
define('WRITABLE_RUNTIME',  is_writable($paths['runtime']));
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <!-- <link href="//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.0/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> -->
...
<?php endif ?>
          ...
          <table width="98%" cellspacing="0" cellpadding="0" align="center" class="listtable" style="margin-top: 3px;">
            ...
            <tr>
              <td class="listtable_1">Assets Folder Writable (/assets)</td>
              <td class="listtable_1">Yes</td>
<?php if(WRITABLE_ASSETS): ?>
...
<?php endif ?>
            ...
            <tr>
              <td class="listtable_1">Game Icon Folder Writable (/images/games)</td>
              <td class="listtable_1">Yes</td>
...
<?php endif ?>
            ...
            <tr>
              <td class="listtable_1">Runtime Folder Writable (/application/runtime)</td>
              <td class="listtable_1">Yes</td>
<?php if(WRITABLE_RUNTIME): ?>
              <td class="green">Yes</td>
<?php else: ?>
              <td class="red">No</td>
<?php endif ?>
            ...
            <tr>
              <td class="listtable_1">Database Config Writable (/application/config)</td>
              <td class="listtable_1">Yes</td>
...
<?php endif ?>
          ...
          <div class="step" id="step-3">
            ...
            <form action="index.php" id="database-form" method="post">
              <fieldset>
                <p>Please enter your database details into the following fields.</p>
                <div>
                  <label for="db_host">Host <span class="required">*</span></label>
                  <input id="db_host" name="db[host]" value="localhost" />
                </div>
                <div>
                  <label for="db_port">Port <span class="required">*</span></label>
                  <input id="db_port" name="db[port]" value="3306" />
                </div>
                <div>
                  <label for="db_user">Username <span class="required">*</span></label>
                  <input id="db_user" name="db[user]" />
                </div>
                <div>
                  <label for="db_pass">Password <span class="required">*</span></label>
                  <input id="db_pass" name="db[pass]" type="password" />
                </div>
                <div>
                  <label for="db_name">Database name <span class="required">*</span></label>
                  <input id="db_name" name="db[name]" />
                </div>
                <div>
                  <label for="db_prefix">Table prefix</label>
                  <input id="db_prefix" name="db[prefix]" value="sb_" />
                </div>
              </fieldset>
            </form>
          </div>
          <div class="step" id="step-4">
            ...
            <form action="index.php" id="admin-form" method="post">
              <fieldset>
                <p>Please enter your admin details into the following fields.</p>
                <div>
                  <label for="SBAdmin_name">Name <span class="required">*</span></label>
                  <input id="SBAdmin_name" name="SBAdmin[name]" />
                </div>
                <div>
                  <label for="SBAdmin_password">Password <span class="required">*</span></label>
                  <input id="SBAdmin_password" name="SBAdmin[password]" type="password" />
                </div>
                <div>
                  <label for="SBAdmin_password_confirm">Confirm password <span class="required">*</span></label>
                  <input id="SBAdmin_password_confirm" name="SBAdmin[password_confirm]" type="password" />
                </div>
                <div>
                  <label for="SBAdmin_email">Email address</label>
                  <input id="SBAdmin_email" name="SBAdmin[email]" />
                </div>
                <div>
                  <label for="SBAdmin_auth">Authentication type</label>
                  <select class="submit-fields" id="SBAdmin_auth" name="SBAdmin[auth]">
                ...
                <div>
                  <label for="SBAdmin_identity">Identity <span class="required">*</span></label>
                  <input class="submit-fields" id="SBAdmin_identity" name="SBAdmin[identity]" value="STEAM_" />
                </div>
              </fieldset>
            </form>
          </div>
          <div class="step" id="step-5">
            ...
            <p>Please delete the install folder and navigate to <a href="../index.php">your SourceBans dashboard</a>.
          </div>
        </div>
      </div>
      <div class="buttons">
